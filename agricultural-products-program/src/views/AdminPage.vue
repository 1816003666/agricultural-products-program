    ...
    <div class="sidebar">
      ...
      <div class="sidebar-menu">
        ...
        <div
          ...
          @click="navigateTo('/products', 'products')"
        >
          <svg
            width="20"
            height="20"
        ...
        <div
          ...
          @click="navigateTo('/reviews', 'reviews')"
        >
          <svg
            width="20"
            height="20"
        ...
        <div
          ...
          @click="navigateTo('/analytics', 'analytics')"
        >
          <svg
            width="20"
            height="20"
